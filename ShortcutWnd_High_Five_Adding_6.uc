...
function OnLoad()
{
	...
	// Option.iniÀÇ ¼³Á¤À» ÀÌ¿ëÇÑ´Ù(TTP#46732) 2011.4.21 - winkey
...
{	
	...
	case EV_ShortcutCommandSlot:
		...
		break;
	case EV_ShortcutPageUpdate:					//Ã¹¹øÂ°¼ôÄÆÃ¢ÀÇ ÆäÀÌÁö°¡ »õ·Î ¼³Á¤µÇ¾úÀ» ¶§ ³¯¶ó¿À´Â ÀÌº¥Æ®
...
function SetCurPage( int a_nCurPage )
{
	...
	//´ÜÃàÅ°´Â Ã¹¹øÂ°¼ôÄÆÃ¢¸¸ ÂüÁ¶ÇÏ¹Ç·Î..
	class'ShortcutAPI'.static.SetShortcutPage( a_nCurPage );
	
	//->EV_ShortcutPageUpdate °¡ ³¯¶ó¿Â´Ù.
}
